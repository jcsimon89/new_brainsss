...
#get to files
#date = '20211215'
dates = ['20240501','20240507','20240514','20240516','20240517', '20240524','20240531']  #as of 4-27 4-5 still has one bad fly as does 330
for date in dates:
  print('STARTING DATE:', str(date))
  #dataset_path = "/oak/stanford/groups/trc/data/Ashley2/imports/" + str(date)
  #dataset_path = "/oak/stanford/groups/trc/data/krave/bruker_data/imports/" + str(date)
  dataset_path = f"/oak/stanford/groups/trc/data/Jacob/Bruker/{date}"
